...
# %% auto 0
__all__ = ['OPENAI_API_KEY', 'ANTHROPIC_API_KEY', 'models', 'model_provider', 'GAME_STATE_FILE', 'MAX_HOPS', 'famous_cities',
           'clue_locations', 'python_repl', 'tools', 'get_llm', 'get_generation_llm', 'get_agent_llm',
           'get_game_states', 'store_game_state', 'get_game_state', 'generate_new_game', 'new_game', 'fetch_game_state',
