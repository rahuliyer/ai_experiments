...
# %% auto 0
__all__ = ['OPENAI_API_KEY', 'ANTHROPIC_API_KEY', 'models', 'model_provider', 'GAME_ENVIRONMENT', 'MAX_HOPS', 'famous_cities',
           'clue_locations', 'python_repl', 'tools', 'get_llm', 'get_generation_llm', 'get_agent_llm',
