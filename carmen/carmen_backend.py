...
# %% auto 0
__all__ = ['OPENAI_API_KEY', 'model', 'GAME_STATE_FILE', 'python_repl', 'tools', 'get_game_states', 'store_game_state',
           'get_game_state', 'new_game', 'fetch_game_state', 'set_current_city', 'update_game_state',
           'generate_destinations', 'generate_regular_clues', 'generate_mistaken_clues', 'generate_arrest_clues',
           'get_agent_executor', 'get_destinations', 'get_clues', 'travel']
...
def new_game():
    ...
    5. A list of 6 unique cities with the current city as the first element, key: hops
...
def get_clues(case_id):
    ...
    2. Write and execute python code passing in the game state to do the following to figure out what kind of 
       clue to generate:
        ...
        b. If next_hop is equal to 5 only then print "arrest clues" as the type of clues
